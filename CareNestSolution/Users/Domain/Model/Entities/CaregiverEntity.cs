...
public class CaregiverEntity
{
    ...
    public void Update(string name, string email, string password, string profilePicture, string role, double rating, string phone, string location, string address, AdditionalInfo additionalInfo, Availability availability)
    {
        Name = name;
        Email = email;
        Password = password;
